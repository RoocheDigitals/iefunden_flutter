...
class CsoWalletDashboardPrefSpendingScreen extends StatelessWidget {
  const CsoWalletDashboardPrefSpendingScreen({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                submitButton(
                    "Preference Spending Items", ColorManager.green, () {}),
                submitButton(
                    "Preference Spending Data", ColorManager.green, () {}),
                submitButton(
                    "Preference Spending Offers", ColorManager.green, () {})
              ],
            ),
          ),
        ),
